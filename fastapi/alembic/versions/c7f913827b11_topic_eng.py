...
Revision ID: c7f913827b11
Revises: e297bbd64464
Create Date: 2023-11-16 15:57:19.283949
...
revision: str = 'c7f913827b11'
down_revision: Union[str, None] = 'e297bbd64464'
...
def downgrade() -> None:
    # delete datas that is_korean is false
    meta = sa.MetaData()
    meta.reflect(only=('topic',),bind= op.get_bind())
    topic_tbl = sa.Table('topic', meta)
    op.execute(topic_tbl.delete().where(topic_tbl.c.is_korean == False))
    # drop 'is_korean' column
