  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: FriendDetailAppBar(
        ...
        userName: "박민준",
        userEmail: "minjun@snu.ac.kr",
      ),
      // TODO 화면 그리기
      body: Text('friend_detail'),
      bottomNavigationBar: Padding(
        padding: EdgeInsets.all(20).copyWith(bottom: 20 + MediaQuery.of(context).padding.bottom/2),
        child: MainButton(mainButtonType: MainButtonType.key, onPressed: controller.onRequestButtonTap, text: "채팅 신청",),
      ),
    );
  }
}
